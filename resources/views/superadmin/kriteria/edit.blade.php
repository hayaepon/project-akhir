...
<div class="bg-white p-6 rounded-lg shadow-md mb-8">
    <h2 class="text-2xl font-medium mb-8 text-[22px]">Edit Kriteria & Bobot</h2>
    ...
    <form action="{{ route('kriteria.update', $kriteria->id) }}" method="POST" class="space-y-4">
        ...
        <div class="flex flex-col mb-4">
            ...
            <select id="beasiswa" name="beasiswa" class="w-full p-3 border-2 border-gray-400 rounded-md shadow-sm text-sm font-medium text-black-700 text-[16px] mb-2" required>
        ...
        <div class="flex flex-col mb-4">
            ...
            <input type="text" id="kriteria" name="kriteria" class="w-full p-3 border-2 border-gray-400 rounded-md shadow-sm text-sm font-medium text-black-700 text-[16px] mb-2" value="{{ old('kriteria', $kriteria->kriteria) }}" required>
        </div>

        <!-- Bobot -->
        <div class="flex flex-col mb-4">
            <label for="bobot" class="text-sm font-medium text-black-700 text-[16px] mb-2">Bobot Kriteria (%)</label>
            <input type="number" id="bobot" name="bobot" class="w-full p-3 border-2 border-gray-400 rounded-md shadow-sm text-sm font-medium text-black-700 text-[16px] mb-2" value="{{ old('bobot', $kriteria->bobot) }}" required>
        </div>
